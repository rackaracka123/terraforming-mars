...
func TestPlayCardAction_DiscountEffectRegistered(t *testing.T) {
	...
	err := playCardAction.Execute(ctx, testGame.ID(), player.ID(), "card-space-station", payment, nil, nil)
...
func TestPlayCardAction_ChoiceCardPlantProduction(t *testing.T) {
	...
	choiceIndex := 0
	err := playCardAction.Execute(ctx, testGame.ID(), player.ID(), "card-artificial-photosynthesis", payment, &choiceIndex, nil)
...
func TestPlayCardAction_WithSingleDiscount(t *testing.T) {
	...
	err = playCardAction.Execute(ctx, testGame.ID(), p.ID(), "card-sponsors", payment, nil, nil)
...
func TestPlayCardAction_WithDoubleDiscount(t *testing.T) {
	...
	err = playCardAction.Execute(ctx, testGame.ID(), p.ID(), "card-earth-office", payment, nil, nil)
	...
	err = playCardAction.Execute(ctx, testGame.ID(), p.ID(), "card-earth-catapult", payment, nil, nil)
...
func TestPlayCardAction_DiscountDoesNotApplyToNonMatchingCard(t *testing.T) {
	...
	err = playCardAction.Execute(ctx, testGame.ID(), p.ID(), "card-arctic-algae", payment, nil, nil)
