...
func CalculateResourceConversionCost(pl *player.Player, conversionType types.StandardProject, baseCost int) int {
	if pl == nil || pl.Effects == nil {
		return baseCost
	}
