...
func (v *Validator) ValidateActionInputs(ctx context.Context, gameID, playerID string, action *actions.PlayerAction, choiceIndex *int) error {
	...
	for _, input := range allInputs {
		...
		case types.ResourceCredits, types.ResourceSteel, types.ResourceTitanium,
			...
			case types.ResourceCredits:
				currentAmount = currentResources.Credits
			case types.ResourceSteel:
				currentAmount = currentResources.Steel
			case types.ResourceTitanium:
				currentAmount = currentResources.Titanium
			case types.ResourcePlants:
				currentAmount = currentResources.Plants
			case types.ResourceEnergy:
				currentAmount = currentResources.Energy
			case types.ResourceHeat:
				currentAmount = currentResources.Heat
			}
