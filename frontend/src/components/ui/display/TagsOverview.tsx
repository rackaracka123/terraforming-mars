...
const TagsOverview: React.FC<TagsOverviewProps> = ({ 
  ...
  const tagTypeInfo = [
    { type: CardTag.BUILDING, icon: '/assets/tags/building.png', label: 'Building' },
    { type: CardTag.SPACE, icon: '/assets/tags/space.png', label: 'Space' },
    { type: CardTag.POWER, icon: '/assets/tags/power.png', label: 'Power' },
    { type: CardTag.SCIENCE, icon: '/assets/tags/science.png', label: 'Science' },
    { type: CardTag.MICROBE, icon: '/assets/tags/microbe.png', label: 'Microbe' },
  ...
  return (
    <div 
      ...
      style={{
        ...
        alignItems: 'center',
        gap: dimensions.gap,
        background: 'linear-gradient(135deg, rgba(60, 40, 80, 0.9) 0%, rgba(50, 30, 70, 0.8) 100%)',
    ...
    >
      ...
      {activeTags.length > 0 && (
        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', maxWidth: '200px', overflow: 'hidden' }}>
