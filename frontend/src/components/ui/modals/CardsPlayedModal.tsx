...
type FilterType = 'all' | CardType.CORPORATION | CardType.AUTOMATED | CardType.ACTIVE | CardType.EVENT | CardType.PRELUDE;
  ...
  const getCardTypeStyle = (type: CardType) => {
    const styles = {
      [CardType.CORPORATION]: {
        background: 'linear-gradient(145deg, rgba(0, 200, 100, 0.2) 0%, rgba(0, 150, 80, 0.3) 100%)',
        borderColor: 'rgba(0, 255, 120, 0.7)',
        glowColor: 'rgba(0, 255, 120, 0.4)',
        badgeColor: '#00ff78'
      },
      [CardType.AUTOMATED]: {
        background: 'linear-gradient(145deg, rgba(0, 150, 255, 0.2) 0%, rgba(0, 100, 200, 0.3) 100%)',
        borderColor: 'rgba(0, 180, 255, 0.7)',
        glowColor: 'rgba(0, 180, 255, 0.4)',
        badgeColor: '#00b4ff'
      },
      [CardType.ACTIVE]: {
        background: 'linear-gradient(145deg, rgba(255, 150, 0, 0.2) 0%, rgba(200, 100, 0, 0.3) 100%)',
        borderColor: 'rgba(255, 180, 0, 0.7)',
        glowColor: 'rgba(255, 180, 0, 0.4)',
        badgeColor: '#ffb400'
      },
      [CardType.EVENT]: {
        background: 'linear-gradient(145deg, rgba(255, 80, 80, 0.2) 0%, rgba(200, 50, 50, 0.3) 100%)',
        borderColor: 'rgba(255, 120, 120, 0.7)',
        glowColor: 'rgba(255, 120, 120, 0.4)',
        badgeColor: '#ff7878'
      },
      [CardType.PRELUDE]: {
        background: 'linear-gradient(145deg, rgba(200, 100, 255, 0.2) 0%, rgba(150, 50, 200, 0.3) 100%)',
    ...
    <div className="steam-cards-played-modal">
        ...
        <div className="modal-header">
          <div className="header-left">
            ...
            <div className="cards-stats">
              ...
              {cardStats.totalVP > 0 && (
                <div className="stat-item">
                  <VictoryPointsDisplay victoryPoints={cardStats.totalVP} size="small" />
                </div>
              )}
              <div className="stat-item">
        ...
        <div className="cards-content">
          {filteredAndSortedCards.length === 0 ? (
            <div className="empty-state">
              <img src="/assets/misc/corpCard.png" alt="No cards" className="empty-icon" />
                ...
                return (
                  ...
                  >
                    ...
                    <div className="card-header">
                      <div className="card-type-badge" style={{ backgroundColor: cardStyle.badgeColor }}>
                        {card.type.toUpperCase()}
                      </div>
                      <div className="card-costs">
                        <CostDisplay cost={card.cost} size="small" />
                        {card.victoryPoints !== undefined && card.victoryPoints > 0 && (
                          <VictoryPointsDisplay victoryPoints={card.victoryPoints} size="small" />
                        )}
                      </div>
                    </div>
                    ...
                    {card.tags && card.tags.length > 0 && (
                      <div className="card-tags">
                        ...
                        {card.tags.length > 4 && (
                          <span className="more-tags">+{card.tags.length - 4}</span>
                        )}
                      </div>
                    )}
          ...
          <div className="card-detail-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="card-detail-content">
              <div className="card-detail-costs">
                ...
                {selectedCard.victoryPoints !== undefined && selectedCard.victoryPoints > 0 && (
                  <VictoryPointsDisplay victoryPoints={selectedCard.victoryPoints} size="medium" />
                )}
              </div>
                  ...
                  <div className="tags-list">
                    {selectedCard.tags.map((tag, tagIndex) => (
                      <div key={tagIndex} className="tag-item">
                        <img src={getTagIcon(tag)} alt={tag} className="tag-icon-large" />
      ...
      <style jsx>{`
        ...
        .card-detail-header {
          ...
          padding: 20px 25px;
          border-bottom: 2px solid rgba(100, 150, 255, 0.3);
          background: linear-gradient(90deg, rgba(30, 40, 60, 0.9) 0%, rgba(40, 50, 70, 0.7) 100%);
        }
